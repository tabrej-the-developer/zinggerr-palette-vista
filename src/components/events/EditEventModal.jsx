...
const EditEventModal = ({ isOpen, onClose, event, onUpdate }) => {
  const [form, setForm] = useState({ title: '', bgColor: '#6C8CFF', textColor: '#FFFFFF', startDate: '', endDate: '', description: '' });
  ...
  return (
    <RoleModal isOpen={isOpen} onClose={onClose} title="Edit Event" maxWidth="max-w-xl">
