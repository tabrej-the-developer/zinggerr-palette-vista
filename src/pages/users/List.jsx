...
const SAMPLE_USERS = [
  { id: 1, name: 'Arjun Mehta', email: 'arjun@zinggerr.com', username: 'arjun_m', phone: '+91 98765 43210', role: 'Admin', gender: 'Male', status: true, avatar: '' },
  ...
  { id: 6, name: 'Priya Sharma', email: 'priya.s@zinggerr.com', username: 'priya_s', phone: '+91 77889 90011', role: 'Admin', gender: 'Female', status: true, avatar: '' },
    ...
    <Backdrop onClose={onClose}>
      <div className="max-w-md mx-auto rounded-2xl p-6 glass-surface shadow-glass">
        <div className="flex items-center justify-between mb-5">
          <h3 className="text-lg font-bold text-main">User Details</h3>
  ...
  return (
    <Backdrop onClose={onClose}>
      <div className="max-w-lg mx-auto rounded-2xl p-6 glass-surface shadow-glass max-h-[85vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-5">
          <h3 className="text-lg font-bold text-main">Edit User</h3>
          <button onClick={onClose} className="p-1.5 rounded-lg hover:bg-[var(--border)] transition-colors">
            <X size={18} className="text-muted-custom" />
          </button>
        </div>
    ...
    <div className="space-y-6">
      ...
      <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={0}
        ...
        <div>
          ...
          <p className="text-sm text-muted-custom mt-1">Manage all users in your system</p>
        </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr style={{ borderBottom: '1px solid var(--border)' }}>
                {['#', 'User', 'Username', 'Phone', 'Role', 'Gender', 'Status', 'Actions'].map(h => (
            ...
            <tbody>
              ...
              {paginated.length === 0 && (
                <tr><td colSpan={8} className="px-5 py-12 text-center text-muted-custom">No users found</td></tr>
              )}
            </tbody>
          </table>
        </div>
