...
const DeleteEventModal = ({ isOpen, onClose, event, onDelete }) => {
  ...
  return (
    <RoleModal isOpen={isOpen} onClose={onClose} title="Delete Event" maxWidth="max-w-md">
      <div className="text-center space-y-4">
        ...
        <div>
          <p className="text-main font-semibold text-base">Are you sure you want to delete this event?</p>
          {event && (
            <p className="text-muted-custom text-sm mt-1">
              Event "<span className="font-medium text-main">{event.title}</span>" will be permanently removed.
            </p>
          )}
        </div>
      </div>
